...
router.post('/', async (req, res) => {
    const { empresaId, empresaNome, titulo, link, resumo, data, imagem } = req.body;
    ...
    try {
        ...
        await client.query(
            `INSERT INTO noticia_salva (empresa_id, empresa_nome, titulo, link, resumo, data_noticia, imagem, data_salvamento)
             VALUES ($1, $2, $3, $4, $5, $6, $7, NOW())`,
            [empresaIdFinal, nomeEmpresa || null, tituloNoticia, linkNoticia, resumoNoticia || null, dataNoticia || null, imagemNoticia || null]
        );
